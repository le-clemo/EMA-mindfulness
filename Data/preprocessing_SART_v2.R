...
write.csv(numbers, "SART/sart_w_thoughtProbes.csv", row.names = FALSE)
write.csv(missing_links, file = "mergedData/missing_links.csv", row.names = FALSE)
write.csv(esm, file = "mergedData/merged_data.csv", row.names = FALSE)
